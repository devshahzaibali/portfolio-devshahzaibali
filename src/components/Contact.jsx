      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <motion.div
            ...
            className="flex-1 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700"
          >
          ...
          >
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 h-full">
              ...
              <div className="mt-12 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                <iframe
